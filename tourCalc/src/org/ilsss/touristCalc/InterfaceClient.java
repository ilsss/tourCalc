...
public class InterfaceClient extends Components {
	...
	public InterfaceClient() throws Exception {
		...
		//Смена цвета заднего фона ===================================================== ЗАДНИЙ ФОН
		//mainPanel.setBackground(Color.GREEN);
		//Смена цвета кнопок       ===================================================== КНОПКИ
		//Кнопка "Отправить заявку менеджеру"
		//button[0].setBackground(Color.GREEN);
		//Кнопка "Очистить поля"
		//button[1].setBackground(Color.GREEN);
		//Кнопка "Вернуться на основное окно"
		//button[2].setBackground(Color.GREEN);
		//ФОН РАДИОКНОПОК          ===================================================== РАДИОКНОПКИ
		//radiobutton[0].setBackground(Color.GREEN);
		//radiobutton[1].setBackground(Color.GREEN);
		//Фон маленьких панелек    ===================================================== ОТДЕЛЬНЫЕ ПАНЕЛЬКИ
		//smallPanel[0].setBackground(Color.GREEN);
		//smallPanel[1].setBackground(Color.GREEN);
		//smallPanel[2].setBackground(Color.GREEN);
		//Фон чекбоксов            ===================================================== ЧЕКБОКСЫ
		//checkbox[0].setBackground(Color.GREEN);
		//checkbox[1].setBackground(Color.GREEN);
		//checkbox[2].setBackground(Color.GREEN);
		/**
